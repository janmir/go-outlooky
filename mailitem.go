...
type MailItem struct {
	...
	RecipientReassignmentProhibited          //Returns a Boolean (bool in C#) that indicates True if the recipient cannot forward the mail message. Read/write.
	...
	To                                       //Returns or sets a semicolon-delimited String (string in C#) list of display names for the To recipients for the Outlook item. Read/write.
